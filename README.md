...
**This tool is a Proof of Concept and is for Educational Purposes Only,Telegram-Messenger shows what data a malicious website can gather about you and your devices and why you should not click on random links and allow critical permissions such as Location etc.**
...
Title 📌Send a general message to members via telegram | Thanks
...
Usage 👌 https://my.telegram.org/auth | python3 Scraper.py | python3 SendMessages.py  
